...
public class LaLaAttributeEvaluationRuleImpl extends ASTWrapperPsiElement implements LaLaAttributeEvaluationRule {

  public LaLaAttributeEvaluationRuleImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LaLaVisitor visitor) {
    visitor.visitAttributeEvaluationRule(this);
  }
  ...
  public LaLaAttributeAccess getAttributeAccess() {
    return findNotNullChildByClass(LaLaAttributeAccess.class);
  }
