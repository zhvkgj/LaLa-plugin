...
public class LaLaAnnotationArgumentImpl extends ASTWrapperPsiElement implements LaLaAnnotationArgument {

  public LaLaAnnotationArgumentImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LaLaExpression getExpression() {
    return findNotNullChildByClass(LaLaExpression.class);
  }
