...
public class LaLaChildReferenceImpl extends ASTWrapperPsiElement implements LaLaChildReference {

  public LaLaChildReferenceImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LaLaVisitor visitor) {
    visitor.visitChildReference(this);
  }
