...
public class LaLaSerializationImpl extends ASTWrapperPsiElement implements LaLaSerialization {

  public LaLaSerializationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LaLaVisitor visitor) {
    visitor.visitSerialization(this);
  }
