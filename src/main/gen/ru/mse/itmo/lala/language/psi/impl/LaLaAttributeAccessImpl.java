...
public class LaLaAttributeAccessImpl extends ASTWrapperPsiElement implements LaLaAttributeAccess {

  public LaLaAttributeAccessImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LaLaVisitor visitor) {
    visitor.visitAttributeAccess(this);
  }
