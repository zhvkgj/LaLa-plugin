...
public class LaLaAttributeTypeNameImpl extends ASTWrapperPsiElement implements LaLaAttributeTypeName {

  public LaLaAttributeTypeNameImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LaLaVisitor visitor) {
    visitor.visitAttributeTypeName(this);
  }
